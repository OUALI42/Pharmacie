...
public class Pharmacie implements Stockable{
    ...
    /**
     * Method for removing a product from stock.
     * The user enters the name of the product to be removed.
     * If the product is found, it is removed from the product list.
     * If the category becomes empty after deletion, it is also deleted.
     */
